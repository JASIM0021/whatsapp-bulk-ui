...
export interface CalendarBranding {
  ...
  themeMode: 'light' | 'dark' | 'midnight' | 'minimal' | 'auto';
  layoutMode?: 'side_by_side' | 'compact' | 'banner';
  cardRadius?: 'none' | 'sm' | 'md' | 'lg' | 'xl' | 'full';
  cardShadow?: 'none' | 'subtle' | 'medium' | 'deep' | 'glow';
  slotShape?: 'rounded' | 'pill' | 'square';
  fontFamily?: 'Inter' | 'Plus Jakarta Sans' | 'Outfit' | 'Poppins' | 'Geist';
